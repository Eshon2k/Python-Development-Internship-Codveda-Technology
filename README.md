Python Development Internship - Codveda Technology

📌 About the Internship
This repository contains the projects completed during my Python Development Internship at Codveda Technology. Codveda is an innovation-driven firm specializing in IT solutions like AI/ML automation, web development, and data analysis. 
...
Navigate to the specific level folder: cd Level_1
Run the script: python task_name.py

🔗 Connect with Me
LinkedIn:https://www.linkedin.com/in/emmanuel-shonga-b84238144?
